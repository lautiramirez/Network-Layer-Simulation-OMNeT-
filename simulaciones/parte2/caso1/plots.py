...
# Cargo base
data = pandas.read_csv('caso1.csv')
print(data)
print(data.columns)
...
time_node_0_lnk0 = data['vectime'].loc[[25]].tolist()
buffer_node_0_lnk0 = data['vecvalue'].loc[[25]].tolist()

time_node_1_lnk1 = data['vectime'].loc[[27]].tolist()
buffer_node_1_lnk1 = data['vecvalue'].loc[[27]].tolist()

time_node_1_lnk0 = data['vectime'].loc[[35]].tolist()
buffer_node_1_lnk0 = data['vecvalue'].loc[[35]].tolist()

time_node_2_lnk1 = data['vectime'].loc[[26]].tolist()
buffer_node_2_lnk1 = data['vecvalue'].loc[[26]].tolist()

time_node_2_lnk0 = data['vectime'].loc[[32]].tolist()
buffer_node_2_lnk0 = data['vecvalue'].loc[[32]].tolist()

time_node_3_lnk1 = data['vectime'].loc[[29]].tolist()
buffer_node_3_lnk1 = data['vecvalue'].loc[[29]].tolist()

time_node_4_lnk1 = data['vectime'].loc[[31]].tolist()
buffer_node_4_lnk1 = data['vecvalue'].loc[[31]].tolist()

time_node_7_lnk0 = data['vectime'].loc[[28]].tolist()
buffer_node_7_lnk0 = data['vecvalue'].loc[[28]].tolist()

time_node_6_lnk0 = data['vectime'].loc[[30]].tolist()
buffer_node_6_lnk0 = data['vecvalue'].loc[[30]].tolist()

time_saltos = data['vectime'].loc[[33]].tolist()
buffer_saltos = data['vecvalue'].loc[[33]].tolist()

time_node_5_app = data['vectime'].loc[[34]].tolist()
buffer_node_5_app = data['vecvalue'].loc[[34]].tolist()
...
#####
ax1 = plt.subplot(212)
plt.suptitle("Caso 1: InterArrivalTime = 1", fontsize=20)
...
ax1 = plt.subplot(212)
plt.suptitle("Caso 1: InterArrivalTime = 1", fontsize=20)
ax1.plot(time_node_3_lnk1, buffer_node_3_lnk1,
         linewidth=1.0, linestyle="-", color='blue', label='node[3].lnk1')
ax1.set_title('Node[3].lnk1')
plt.grid()

ax2 = plt.subplot(221)
ax2.plot(time_node_4_lnk1, buffer_node_4_lnk1,
        linewidth=1.0, linestyle="-", color='blue', label='node[4].lnk1')
ax2.set_title('Node[4].lnk1')
plt.grid()

ax3 = plt.subplot(222)
ax3.plot(time_node_6_lnk0, buffer_node_6_lnk0, 
        linewidth=1.0, linestyle="-", color='green', label='node[6].lnk0')
ax3.set_title('Node[6].lnk0')
...
ax2.set_title('Saltos')
ax2.legend()
plt.grid()

ax3 = plt.subplot(222)
ax3.plot(time_node_4_lnk1, buffer_node_4_lnk1,
