...
# Cargo base
data = pandas.read_csv('caso2_arrivaltime_2.csv')
print(data)
print(data.columns)
...
time_node_1_lnk0 = data['vectime'].loc[[31]].tolist()
buffer_node_1_lnk0 = data['vecvalue'].loc[[31]].tolist()

time_node_1_lnk1 = data['vectime'].loc[[28]].tolist()
buffer_node_1_lnk1 = data['vecvalue'].loc[[28]].tolist()

time_node_2_lnk0 = data['vectime'].loc[[33]].tolist()
buffer_node_2_lnk0 = data['vecvalue'].loc[[33]].tolist()

time_node_2_lnk1 = data['vectime'].loc[[30]].tolist()
buffer_node_2_lnk1 = data['vecvalue'].loc[[30]].tolist()

time_node_3_lnk0 = data['vectime'].loc[[34]].tolist()
buffer_node_3_lnk0 = data['vecvalue'].loc[[34]].tolist()

time_node_3_lnk1 = data['vectime'].loc[[32]].tolist()
buffer_node_3_lnk1 = data['vecvalue'].loc[[32]].tolist()

time_node_4_lnk0 = data['vectime'].loc[[29]].tolist()
buffer_node_4_lnk0 = data['vecvalue'].loc[[29]].tolist()

time_node_4_lnk1 = data['vectime'].loc[[25]].tolist()
buffer_node_4_lnk1 = data['vecvalue'].loc[[25]].tolist()
...
time_saltos = data['vectime'].loc[[26]].tolist()
buffer_saltos = data['vecvalue'].loc[[26]].tolist()

time_node_5_app = data['vectime'].loc[[27]].tolist()
buffer_node_5_app = data['vecvalue'].loc[[27]].tolist()
...
#####
ax1 = plt.subplot(212)
plt.suptitle("Caso 2: InterArrivalTime = 2", fontsize=20)
